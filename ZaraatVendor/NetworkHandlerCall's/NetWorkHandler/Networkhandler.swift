...
class func PostRequest(url: String, parameters: Parameters?, success:@escaping (DataResponse<Any>)->Void ,Falioure: @escaping (NetworkError) -> Void )
    ...
    class func UploadData(url: String,filename:String, parameters: Parameters?,userimg: UIImage,Progress: @escaping (Int) ->Void, Success: @escaping (DataResponse<Any>)->Void, Falioure: @escaping (NetworkError) -> Void)
    {
        var Headers : HTTPHeaders
        let Manger = Alamofire.SessionManager.default
        if let userToken = ShareData.shareInfo.userInfo?.token {
    ...
    class func UploadImage1(url: String,filename:String, parameters: Parameters?,gellaryimg: [UIImage],Progress: @escaping (Int) ->Void, Success: @escaping (DataResponse<Any>)->Void, Falioure: @escaping (NetworkError) -> Void)
    {
        var Headers : HTTPHeaders
        let Manger = Alamofire.SessionManager.default
        //print(UserDefaults.standard.value(forKey: "userAuthToken")!)
...
//                        }
    ...
    class func Uploadfiels(url: String,filename: String, parameters: Parameters?,videourl: URL,Progress: @escaping (Int) ->Void, Success: @escaping (DataResponse<Any>)->Void, Falioure: @escaping (NetworkError) -> Void)
    {
        var Headers : HTTPHeaders
        let Manger = Alamofire.SessionManager.default
        //print(UserDefaults.standard.value(forKey: "userAuthToken")!)
...
//            }
    ...
    class func UploaDealImage(url: String,filename: String, parameters: Parameters?,img: UIImage,Progress: @escaping (Int) ->Void, Success: @escaping (DataResponse<Any>)->Void, Falioure: @escaping (NetworkError) -> Void)
        {
            var Headers : HTTPHeaders
            let Manger = Alamofire.SessionManager.default
            //print(UserDefaults.standard.value(forKey: "userAuthToken")!)
