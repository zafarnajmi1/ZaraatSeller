...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/Crisp/Crisp.xcframework" "${PODS_ROOT}/Crisp/Crisp.dSYMs" "true" "ios-i386_x86_64-simulator/Crisp.framework" "ios-armv7_arm64/Crisp.framework"
fi
